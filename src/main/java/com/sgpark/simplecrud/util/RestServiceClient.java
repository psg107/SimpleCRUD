...
import com.sgpark.simplecrud.model.common.service.ServiceResponse;
...
public class RestServiceClient<T extends IRequestBase> {
    ...
    public <T2 extends ServiceResponse> T2 request(Class<T2> responseClass) {
        ...
        HttpEntity<T> requestEntity = switch (this.method) {
            case GET, DELETE -> new HttpEntity<T>(headers);
